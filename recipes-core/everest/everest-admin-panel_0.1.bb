...
LICENSE:${PN}-mdi-font = "Apache-2.0 & MIT"
LICENSE:${PN}-mdi-js = "Apache-2.0 & MIT"
...
LICENSE:${PN}-debounce-promise = "MIT"
LICENSE:${PN}-debug = "MIT"
LICENSE:${PN}-entities = "BSD-3-Clause"
LICENSE:${PN}-expr-eval = "MIT"
LICENSE:${PN}-fast-copy = "MIT"
LICENSE:${PN}-fast-deep-equal = "MIT"
LICENSE:${PN}-fast-equals = "MIT"
...
LICENSE:${PN}-match-all = "MIT"
LICENSE:${PN}-mdurl = "MIT"
LICENSE:${PN}-ms = "MIT"
LICENSE:${PN}-nanoid = "MIT"
LICENSE:${PN}-picocolors = "ISC"
LICENSE:${PN}-postcss = "MIT"
LICENSE:${PN}-property-expr = "MIT"
LICENSE:${PN}-punycode = "MIT"
LICENSE:${PN}-register-service-worker = "MIT"
LICENSE:${PN}-require-from-string = "MIT"
LICENSE:${PN}-roboto-fontface = "Apache-2.0"
LICENSE:${PN}-sortablejs = "MIT"
