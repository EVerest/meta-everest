...
SRC_URI = "file://package.json \
           ...
           file://flows.json \
           file://flows-all-chargers.json \
          "
S = "${WORKDIR}"

FILES_${PN} += "/home/root/.node-red/flows.json \
...
INSANE_SKIP_${PN} = "already-stripped useless-rpaths arch file-rdeps staticdev"

EXCLUDE_FROM_SHLIBS = "1"

LICENSE_${PN} = "Apache-2.0"
LICENSE_${PN}-socketio-component-emitter = "MIT"
LICENSE_${PN}-types-cookie = "MIT"
LICENSE_${PN}-types-cors = "MIT"
LICENSE_${PN}-types-node = "MIT"
...
LICENSE_${PN}-gridstack = "MIT"
LICENSE_${PN}-http-errors = "MIT"
LICENSE_${PN}-inherits = "ISC"
LICENSE_${PN}-jquery = "MIT"
LICENSE_${PN}-mime = "MIT"
LICENSE_${PN}-mime-db = "MIT"
LICENSE_${PN}-mime-types = "MIT"
LICENSE_${PN}-ms = "MIT"
LICENSE_${PN}-negotiator = "MIT"
LICENSE_${PN}-node-red-contrib-ui-actions = "MIT"
LICENSE_${PN}-node-red-contrib-ui-level = "MIT"
LICENSE_${PN}-node-red-dashboard = "Apache-2.0"
LICENSE_${PN}-node-red-node-ui-table = "Apache-2.0"
